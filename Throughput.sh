#!/bin/bash
#Parameters
impl="NEW_bgParam-MAPTPERF-TP-Jool-BME-10G-1000_CEs-EAbits13-Fg100-frameSize84-16CoresAtDUT" # name of the tested implementation (used for logging)
...
m=9 # E.g. n=m=2 is all foreground traffic; n=2,m=0 is all background traffic; n=10,m=9 is 90% fg and 10% bg
...
do
	...
	do 
		...
		echo "Command line is: ./build/maptperf-tp $fs $r $xpts $to $n $m"
		# Execute the test program
		./build/maptperf-tp $fs $r $xpts $to $n $m > temp.out 2>&1
