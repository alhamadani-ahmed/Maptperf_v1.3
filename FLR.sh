#!/bin/bash
#Parameters
impl="MAPTPERF-FLR-Jool-BME--10G-1000_CEs-EAbits13-Fg100-16coresAtDUT" # name of the tested implementation (used for logging)
dir="b" # valid values: b,f,r; b: bidirectional, f: forward (Left to Right, 6 --> 4), r: reverse (Right to Left, 6 <-- 4) 
rate_start=1200000 # starting from this packet rate
rate_end=1200000 # ending at this packet rate
rate_step=200000 # increase of the for cycle: for (( r=rate_start; r <= rate_end; r+=rate_step ))
fsizes="1044" # IPv6 frame size; IPv4 frame size is always 20 bytes less 
